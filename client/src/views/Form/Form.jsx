...
const Form = () => {
 ...
 const handleSelect = (event) => {
     ...
     setSelect(`Ordenado ${event.target.value}`)}
        ...
        <div className={style.form}>
            <form onSubmit={submitHandler}>
                ...
                <div>
                    ...
                    <div><input id="difficulty" type="range" min="1" max="5" value="1" value={form.difficulty}
                                onChange={changeHandler} name="difficulty"></input></div>
                ...
                <ul><li>{form.country.map(el => el+" ,")}</li></ul>
